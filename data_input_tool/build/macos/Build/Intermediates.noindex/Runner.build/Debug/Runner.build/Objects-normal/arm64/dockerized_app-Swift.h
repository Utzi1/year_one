...
#ifndef DOCKERIZED_APP_SWIFT_H
#define DOCKERIZED_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="dockerized_app",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14dockerized_app11AppDelegate")
...
SWIFT_CLASS("_TtC14dockerized_app17MainFlutterWindow")
